...
mkdir -p src test docs/tickets/feature

# Create a simple implementation plan
cat > docs/tickets/feature/index.html <<'EOF'
...
I want you to execute the implementation plan at docs/tickets/feature/index.html using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/tickets/feature/index.html using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"sage-mode:subagent-driven-development"' "$SESSION_FILE"; then
