...
import { parseJsonl, toJsonl, gate, dedup, scope as reviewScope, select as reviewSelect, } from "./review/index.js";
import { consult } from "./consult/index.js";
import { loadLedger, saveLedger, parseLedger, next as boardNext, writeStatus, writeBlocker, writeAnswer, activeSprint, } from "./board/index.js";
    ...
    if (cmd === "evidence") {
        ...
        if (sub === "run") {
            ...
            if (!label || !cmdv.length)
                fail("sage evidence run --label L -- <cmd>");
