...
import { buildIndex, search, bm25, overlap, tokenize, dedupAppliesWhen, type IndexDoc } from "../lib/recall/index.js";

function doc(partial: Partial<IndexDoc> & { terms: Record<string, number> }): IndexDoc {
  return {
    id: "d",
    path: "d.md",
    kind: "note",
...
test("buildIndex tags kind from frontmatter and indexes three roots including out-of-scope", () => {
  ...
  writeFileSync(
    join(dir, ".sage", "out-of-scope", "rejected.md"),
