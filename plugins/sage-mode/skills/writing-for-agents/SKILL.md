...
Sage Mode: other skills stay opt-in. Unslop still applies to every page. When the document is a skill, read [`SKILL-MECHANICS.md`](SKILL-MECHANICS.md) for frontmatter, invocation choice, and router skills.
